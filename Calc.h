...
namespace calc{
	...
	MeasuredCurrent outer_circuit_current(Morphology &device_parameters, const PositionDependentParameter &electron_current, const PositionDependentParameter &hole_current, const PositionDependentParameter &net_rate);
