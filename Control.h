...
namespace control{
	...
	void determine_rates(Morphology &morph, PositionDependentParameter &net_rate, NegativeMobileCharge &electron, PositiveMobileCharge &hole, PositionDependentParameter &potential, PositionDependentParameter& recombination_current_x, PositionDependentParameter& recombination_current_y);
