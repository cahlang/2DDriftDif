...
void NegativeMobileCharge::solve_inverse(Morphology &material, const Potential &potential){

	// The algorithm used here is SparseLU from Eigen
				...
				if (material.is_electrode_interface(site) && !material.surface_recombination_activated(material.get_electrode_material_interface_number(site))){
					...
					if (material.is_electrode_interface(site) && material.surface_recombination_activated(material.get_electrode_material_interface_number(site))){
						...
						if (material.is_electrode(site_x_minus)){
							...
							b(site - concentration.points_y) = -material.get_surface_recombination_velocity_electron(electrode_material_interface_number) / concentration.spacing_x * material.get_electron_trans_DOS(site) * std::min(exp(material.get_electron_trans_energy(site) - work_function), 1.0);
						}
	...
	if (solver.info() != Success) {
		std::cerr << "Electroncon decomposition failed" << std::endl;
		return;
	}
...
void NegativeMobileCharge::solve_inverse(Morphology& material, const Potential& potential, const PositionDependentParameter& previous_time_concentration, double time_step) {
...
void NegativeMobileCharge::solve_one_d(Morphology &material, const Potential &potential){
	...
	for (int i = 0; i < b.size(); i++){
		...
		if (i == 0){
			...
			if (material.is_interface(site) && material.is_interface(site_x_minus)){
				int pair_number = material.get_interface_pair(site, site_x_minus);
				b[i] += -material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site_x_minus) + potential.electrical.data[site_x_minus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0);
				a[i] = material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_x_minus) - potential.electrical.data[site_x_minus]), 1.0);
			}
			else{
				b[i] += -1.0 / pow(concentration.spacing_x, 2.0) * material.get_electron_mobility(site, site_x_minus) * calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_x_minus] - material.get_electron_trans_energy(site_x_minus));
				a[i] = material.get_electron_mobility(site, site_x_minus) / pow(concentration.spacing_x, 2.0) * calc::bernou(potential.electrical.data[site_x_minus] + material.get_electron_trans_energy(site_x_minus) - potential.electrical.data[site] - material.get_electron_trans_energy(site));
			...
			if (material.is_interface(site) && material.is_interface(site_x_plus)){
				int pair_number = material.get_interface_pair(site, site_x_plus);
				b[i] += -material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site_x_plus) + potential.electrical.data[site_x_plus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0);
				c[i] = material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_x_plus) - potential.electrical.data[site_x_plus]), 1.0);
			}
			else{
				b[i] += -1.0 / pow(concentration.spacing_x, 2.0) * material.get_electron_mobility(site, site_x_plus) * calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_x_plus] - material.get_electron_trans_energy(site_x_plus));
				c[i] = material.get_electron_mobility(site, site_x_plus) / pow(concentration.spacing_x, 2.0) * calc::bernou(potential.electrical.data[site_x_plus] + material.get_electron_trans_energy(site_x_plus) - potential.electrical.data[site] - material.get_electron_trans_energy(site));
	...
	for (int n = upper_bound; n >= lower_bound; n--){
		...
		if (concentration.data[i] > material.get_electron_trans_DOS(i))
			concentration.data[i] = material.get_electron_trans_DOS(i);
	...
	for (int i = 0; i < b.size(); i++){
		...
		if (i == 0){
			...
			if (material.is_interface(site) && material.is_interface(site_x_minus)){
				int pair_number = material.get_interface_pair(site, site_x_minus);
				b[i] += -material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site_x_minus) + potential.electrical.data[site_x_minus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0);
				// Should there be a spacin_x here somewhere?
				a[i] = material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_x_minus) - potential.electrical.data[site_x_minus]), 1.0);
			}
			else{
				b[i] += -1.0 / pow(concentration.spacing_x, 2.0) * material.get_electron_mobility(site, site_x_minus) * calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_x_minus] - material.get_electron_trans_energy(site_x_minus));
	...
	if (material.is_electrode_interface(site) && !material.surface_recombination_activated(material.get_electrode_material_interface_number(site))){
		...
		if (material.is_electrode_interface(site) && material.surface_recombination_activated(material.get_electrode_material_interface_number(site))){
			...
			if (material.is_electrode(site_x_minus)){
				...
				b = -material.get_surface_recombination_velocity_electron(electrode_material_interface_number) / concentration.spacing_x * material.get_electron_trans_DOS(site) * std::min(exp(material.get_electron_trans_energy(site) - work_function), 1.0);
			}
			else if (material.is_electrode(site_x_plus)){
			...
			if ((material.is_interface(site) && material.is_interface(site_x_minus) && (material.get_lattice_number(site) != material.get_lattice_number(site_x_minus)))){
				int pair_number = material.get_interface_pair(site, site_x_minus);
				a[0] += -material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site_x_minus) + potential.electrical.data[site_x_minus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]),1.0);
				a[1] += material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x *std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_x_minus) - potential.electrical.data[site_x_minus]), 1.0) * concentration.data[site_x_minus];
			}
			else{
				a[0] += -material.get_electron_mobility(site, site_x_minus) / pow(concentration.spacing_x, 2.0) * calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_x_minus] - material.get_electron_trans_energy(site_x_minus));
				a[1] += material.get_electron_mobility(site, site_x_minus) / pow(concentration.spacing_x, 2.0) * calc::bernou(potential.electrical.data[site_x_minus] + material.get_electron_trans_energy(site_x_minus) - potential.electrical.data[site] - material.get_electron_trans_energy(site)) * concentration.data[site_x_minus];
			}

			if ((material.is_interface(site) && material.is_interface(site_x_plus) && (material.get_lattice_number(site) != material.get_lattice_number(site_x_plus)))){
				int pair_number = material.get_interface_pair(site, site_x_plus);
				a[0] += -material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site_x_plus) + potential.electrical.data[site_x_plus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0);
				a[2] += material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_x * std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_x_plus) - potential.electrical.data[site_x_plus]), 1.0) * concentration.data[site_x_plus];
			}
			else{
				a[0] += -material.get_electron_mobility(site, site_x_plus) / pow(concentration.spacing_x, 2.0) * calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_x_plus] - material.get_electron_trans_energy(site_x_plus));
				a[2] += material.get_electron_mobility(site, site_x_plus) / pow(concentration.spacing_x, 2.0) * calc::bernou(potential.electrical.data[site_x_plus] + material.get_electron_trans_energy(site_x_plus) - potential.electrical.data[site] - material.get_electron_trans_energy(site)) * concentration.data[site_x_plus];
			}
		...
		if (concentration.points_x > 1){
			...
			if ((material.is_interface(site) && material.is_interface(site_y_minus) && (material.get_lattice_number(site) != material.get_lattice_number(site_y_minus)))){
				int pair_number = material.get_interface_pair(site, site_y_minus);
				a[0] += -material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_y * std::min(exp(material.get_electron_trans_energy(site_y_minus) + potential.electrical.data[site_y_minus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0);
				a[3] += material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_y *std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_y_minus) - potential.electrical.data[site_y_minus]), 1.0) * concentration.data[site_y_minus];
			}
			else{
				a[0] += -material.get_electron_mobility(site, site_y_minus) / pow(concentration.spacing_y, 2.0) * calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_y_minus] - material.get_electron_trans_energy(site_y_minus));
			...
			if ((material.is_interface(site) && material.is_interface(site_y_plus) && (material.get_lattice_number(site) != material.get_lattice_number(site_y_plus)))){
				int pair_number = material.get_interface_pair(site, site_y_plus);
				a[0] += -material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_y * std::min(exp(material.get_electron_trans_energy(site_y_plus) + potential.electrical.data[site_y_plus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0);
				a[4] += material.get_interface_electron_transfer_velocity(pair_number) / concentration.spacing_y *std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_y_plus) - potential.electrical.data[site_y_plus]), 1.0) * concentration.data[site_y_plus];
			}
			else{
				a[0] += -material.get_electron_mobility(site, site_y_plus) / pow(concentration.spacing_y, 2.0) * calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_y_plus] - material.get_electron_trans_energy(site_y_plus));
	...
	for (int i = 0; i < concentration.points_x; i++){
		for (int j = 0; j < concentration.points_y; j++){
			...
			if (i < concentration.points_x - 1 && !material.is_electrode(site) && !material.is_electrode(site_x_plus)){
				...
				if ((material.is_interface(site) && material.is_interface(site_x_plus)) && (material.get_lattice_number(site) != material.get_lattice_number(site_x_plus))){
					int pair_number = material.get_interface_pair(site, site_x_plus);
					current_x.data[site] = -material.get_interface_electron_transfer_velocity(pair_number) * (concentration.data[site] * std::min(exp(material.get_electron_trans_energy(site_x_plus) + potential.electrical.data[site_x_plus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0)
						- concentration.data[site_x_plus] * std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_x_plus) - potential.electrical.data[site_x_plus]), 1.0));
				}
				else{
			...
			if (current_y.points_y > 1){
				...
				if (!material.is_electrode(site) && !material.is_electrode(site_y_plus)){
					...
					if ((material.is_interface(site) && material.is_interface(site_y_plus)) && (material.get_lattice_number(site) != material.get_lattice_number(site_y_plus))){
						int pair_number = material.get_interface_pair(site, site_y_plus);
						current_y.data[site] = -material.get_interface_electron_transfer_velocity(pair_number) *(concentration.data[site] * std::min(exp(material.get_electron_trans_energy(site_y_plus) + potential.electrical.data[site_y_plus] - material.get_electron_trans_energy(site) - potential.electrical.data[site]), 1.0)
							- concentration.data[site_y_plus] * std::min(exp(material.get_electron_trans_energy(site) + potential.electrical.data[site] - material.get_electron_trans_energy(site_y_plus) - potential.electrical.data[site_y_plus]), 1.0));
					}
					else{
						current_y.data[site] = -material.get_electron_mobility(site, site_y_plus) / current_y.spacing_x * (calc::bernou(potential.electrical.data[site] + material.get_electron_trans_energy(site) - potential.electrical.data[site_y_plus] - material.get_electron_trans_energy(site_y_plus)) * concentration.data[site]
